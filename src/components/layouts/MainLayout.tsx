...
import footerLogo from "../../assets/images/prepdosth header.png";
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50 font-sans overflow-hidden">
      ...
      <main id="main-content" className="flex-grow w-full overflow-y-auto">
        <Outlet />
        <footer className="bg-[#0a0a0a] text-gray-300 pt-16 pb-8 border-t border-gray-800 relative overflow-hidden print:hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-16">
              <div className="lg:col-span-2">
                <Link to="/" className="inline-block mb-6">
                  <img src={footerLogo} alt="PrepDosth Logo" className="h-10 object-contain" />
                </Link>
          ...
          {/* Big Branding Background Text - Absolute Positioned */}
          <div className="absolute bottom-[-2vw] left-1/2 -translate-x-1/2 select-none pointer-events-none z-0 overflow-hidden">
            <h2 className="text-[16vw] md:text-[14vw] font-black leading-none text-white/[0.02] tracking-tighter uppercase whitespace-nowrap">
              Prep Dosth
            </h2>
          </div>
        </footer>
